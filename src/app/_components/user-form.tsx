...
import { userSchema, type UserSchema } from "@/drizzle/schema/user";
...
export function UserForm({ defaultValues }: Props) {
    ...
    return (
        <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="max-w-96 space-y-6">
                {(mode === "signUp" || mode === "update") && (
                    <>
                        <Input control={form.control} name="fullName" label="Full Name" />
                        <Input control={form.control} name="age" label="Age" type="number" />
                    </>
                )}
                ...
                {(mode === "signUp" || mode === "signIn") && (
                    <>
                        ...
                        <Input control={form.control} name="password" label="Password" type="password" />
                    </>
                )}
