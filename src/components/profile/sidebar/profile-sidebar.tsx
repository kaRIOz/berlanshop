        ...
        <div className="lg:h-screen lg:max-w-[330px] lg:col-span-2 lg:border border-gray-100 rounded-lg">
            <div className="sticky top-0">
                <div className="flex justify-between items-center py-[14px] mx-[14px] border-b">
                    <div className="">
                        <p>ایمان</p>
                        <span className="opacity-40 tracking-wide font-medium text-[14px]">
                ...
                <div className="font-medium text-[14px]">
                    ...
                    <div className="px-4 hover:bg-[#f5f5f5]">
                        <Link href={"/profile/basket"} className="border-b py-4 flex items-center gap-2 ">
                            <TfiShoppingCart />
                            <p>سبد خرید</p>
                            <MdKeyboardArrowLeft className="lg:hidden block mr-auto" />
                        </Link>
                    ...
                    <div className="border-b py-4 flex items-center gap-2 hover:bg-[#f5f5f5] px-4">
                        <IoExitOutline />
                        <button onClick={() => signOut({ redirect: false }).then(() => router.push("/"))}>خروج</button>
                        <MdKeyboardArrowLeft className="lg:hidden block mr-auto" />
                    </div>
                </div>
            </div>
